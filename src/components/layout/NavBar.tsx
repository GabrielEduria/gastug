    ...
    return (
       <section className="w-full h-[45px] mb-30">
          <div className="max-w-[880px] mx-auto flex flex-end justify-between  gap-5 sm:gap-20 px-2 overflow-hidden py-3">
              <Link href="/">
                <p className="flex text-white cursor-pointer hover:opacity-50 hover:underline decoration-[2px] underline-offset-[3px] md:underline-offset-[5px] lg:text-xl pr-5">
              ...
              <div className="text-clip text-white">
                <h2 className="text-base lg:text-xl">
                  ...
                  <a href="http://gabrieleduria.com"
                    className="hover:scale-90 hover:underline hover:opacity-50"
                  > Gabbyyyy </a>
                </h2>
              </div>
          </div>
